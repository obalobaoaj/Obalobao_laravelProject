                ...
                <div class="mb-6 rounded-lg border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900/50">
                    ...
                    <form action="{{ route('students.store') }}" method="POST" class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="Enter phone number"  class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">
                            @error('phone')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-full">
                            ...
                            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="px-4 py-3 text-center text-sm text-neutral-600 dark:text-neutral-400">No students found.</td>
                                </tr>
                                @endforelse
